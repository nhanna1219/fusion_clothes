...
<div {{ $attributes->class([
    ...
    <div class="mt-2 px-4 pb-3 w-full z-10">
        ...
        <div class="flex justify-between">
            <a href="#" class="flex items-center justify-center rounded-md bg-stone-950 px-3 py-2 text-center text-[0.6rem] font-medium text-white hover:bg-stone-800 focus:outline-none focus:ring-4 focus:ring-blue-300 transition duration-300 ease-in-out">
            ...
            <a href="#" class="flex items-center justify-center rounded-md bg-neutral-800 px-3 py-2 text-center text-[0.6rem] font-medium text-white hover:bg-neutral-600 focus:outline-none focus:ring-4 focus:ring-blue-300 transition duration-300 ease-in-out ml-3">
