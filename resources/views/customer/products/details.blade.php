        ...
        <div class="mt-16 ml-24 mr-24 flex  mb-16">
            ...
            <div class="w-[60%]">
                        ...
                        <span
                            ...
                            @switch ($color)
                                ...
                                @case ('brown')
                                    ...
                                    @break
                            @endswitch
                            rounded-full border-2 border-transparent peer-checked:border-blue-500 peer-checked:border-[3px] shadow hover:shadow-lg transition-shadow duration-300 transform peer-checked:scale-110"></span>
                    </label>
                    @endforeach
                ...
                <ul class="w-[70%] grid  gap-2 grid-cols-6 mb-5">
                    ...
                    <li>
                        <input type="radio" id="Size_{{ $size }}" name="Size" value="" class="hidden peer" required />
