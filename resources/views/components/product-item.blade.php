{{-- @props(['productType', 'productRating', 'productName', 'productPrice'])
<div class="flex flex-col w-[200px] text-[16px]">
    <img src="{{asset ('storage/product_image.png')}}" alt="">
    <div class="flex items-center justify-between">
        <div class="text-[#818181] text-[14px]">{{ $productType }}</div>
        <div class="flex gap-x-1 items-center">
            <img src="{{asset ('storage/ic_round-star.png')}}" alt="">
            <div class="font-medium text-[14px]">{{ $productRating }}</div>
        </div>
    </div>
    <div class="font-bold">
            {{ $productName }}
