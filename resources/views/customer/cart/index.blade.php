                ...
                <table class="table table-fixed w-[60%]">
                    ...
                    <tbody class="col-auto text-center my-10 mx-10">
                        <tr>
                            <td align="center">
                                <div class="flex">
                                    <img src="{{ asset('storage/product_image.png') }}" alt=""
                                        class="px-4 py-2 max-w-[150px] object-cover overflow-hidden">
                                    <div class="flex-col my-7">
                                        <div class="font-bold text-lg">Trendy black coat</div>
                                        <div class="text-sm">Color: Brown </div>
                                        <div class="text-sm">Size: XXL</div>
                                    </div>
                                </div>
                            </td>
                            <td align="center" class="text-lg font-bold">$75.00</td>
                            <td align="center">
                                <div class="relative flex items-center justify-center w-[6.1rem]">
                            ...
                            <td align="center" class="text-lg font-bold">$300.00</td>
                            <td align="center">
