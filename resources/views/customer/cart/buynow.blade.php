                ...
                <table class="table table-fixed w-[60%]">
                    ...
                    <tbody class="col-auto text-center ">
                        <tr>
                            <td>
                                <div class="flex">
                                    <img src="{{asset ($product->images->first()->image_path) }}" alt="" class="px-4 py-2 max-w-[150px] object-cover overflow-hidden">
                            ...
                            <td align="center">
                                <div class="relative flex items-center justify-center w-[6.9rem]">
                                    <button onclick="" type="button" id="decrement-button" class=" hover:bg-gray-200 border border-gray-300 rounded-s-lg p-2 h-11 focus:ring-gray-100 focus:ring-2 focus:outline-none">
                                    ...
                                    <button type="button" id="increment-button" class="hover:bg-gray-200 border border-gray-300 rounded-e-lg p-2 h-11 focus:ring-gray-100 focus:ring-2 focus:outline-none">
