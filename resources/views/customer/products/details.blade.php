    ...
    <div>
        <div class="bg-[#f5f5f5] w-full h-[150px] flex flex-col justify-center items-center relative z-10 overflow-hidden">
            ...
            <div class="flex flex-col gap-y-3 justify-center items-center">
                ...
                <div class="text-[#636363]"> <a href="{{ route('customer.home') }}">Home</a> / <a href="{{ route('customer.products.index') }}">Shop</a> / <a href="{{ route('customer.products.details', $product->id) }}">Product Details</a>
                </div>
            </div>
        </div>
        ...
        <div class="mt-16 ml-24 mr-24 flex  mb-16">
            ...
            <div class="w-[60%]">
                ...
                <div class="flex items-center pb-3">
                    ...
                    <svg class="w-8 h-8 text-gray-300 me-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                        <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" />
                    </svg>
                ...
                <ul class="w-[70%] grid  gap-2 grid-cols-10 mb-5">
                    ...
                    <li>
                        <input id="Color_{{$color}}" type="radio" name="color" value="{{ $color }}" class="hidden peer " required>
                        <label for="Color_{{$color}}" class="flex items-center space-x-3 cursor-pointer 
                ...
                <ul class="w-[70%] grid  gap-2 grid-cols-6 mb-5">
                    ...
                    <li>
                        <input type="radio" id="Size_{{ $size }}" name="size" value="{{$size}}" class="hidden peer" required />
                        <label for="Size_{{ $size }}" class="inline-flex justify-center items-center  w-full p-2 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:text-white    peer-checked:bg-black peer-hover:text-white peer-hover:bg-black ">
                ...
                <div class="flex w-full mt-14 items-center">
                    ...
                    <button type="button" id="add_to_cart" class="w-1/5 mr-6 text-black bg-white h-14 text-[17px] rounded-md hover:bg-black hover:text-white border-black border-2 ">Add
                        to cart</button>
                    ...
                    <form class="w-1/5 mr-6 " id="buy" action="{{ route('customer.cart.buynow', $product->id  ) }}">
                        <div class="flex justify-center">
                            ...
                            <button type="submit" id="buynow" class="w-full text-black bg-white h-14 text-[17px] rounded-md hover:bg-black hover:text-white border-black border-2">Buy
                                Now</button>
                        </div>
                    </form>
