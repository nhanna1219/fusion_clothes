<div class="relative w-full flex justify-center">
    <div class="flex rounded overflow-hidden w-full">
        ...
        <input id="search-input" wire:model.live.debounce.100ms="query" wire:keydown.enter="redirectToShop" class="w-full border-none focus:ring-0 focus:outline-none ml-[.75rem] mr-[1rem]" type="text" placeholder="Search product" autocomplete="off">
    </div>
